...
setwd("/Users/yaolin/Desktop/My papers/Manuscripts/2025 - Induced tannin/Submission - Plant Diversity - 1226/Data")
data <- read_excel("Raw data - Induced tannin - 0322.xlsx")
write.csv(data, file = "data.csv", row.names = FALSE)
data <- read.csv("data.csv")

setwd("/Users/yaolin/Desktop/My papers/Manuscripts/2025 - Induced tannin/Submission - Plant Diversity - 1226/Data")
infile  <- "Raw data - Induced tannin - 0322.xlsx"
...
rm10 <- rma.mv(lnRR, rvar,
               mods = ~ paste(Life_span, Plant_type) - 1,
               random = list(~ 1 | Publication/Effect_ID, ~ 1 | Plant_species),
               method = "REML",
               data = data)
rm10
...
models <- list(rm21=rm21, rm22=rm22, rm23=rm23, rm24=rm24, rm25=rm25, rm26=rm26,
               rm27=rm27, rm28=rm28, rm29=rm29, rm30=rm30, rm31=rm31, rm32=rm32,
